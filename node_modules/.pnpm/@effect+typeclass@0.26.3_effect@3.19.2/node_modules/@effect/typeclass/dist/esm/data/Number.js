 ...
 * @since 0.24.0
 */
export const SemigroupSum = /*#__PURE__*/semigroup.make((self, that) => self + that);
/**
 ...
 * @since 0.24.0
 */
export const SemigroupMultiply = /*#__PURE__*/semigroup.make((self, that) => self * that, (self, collection) => {
  if (self === 0) {
    return 0;
  }
  let out = self;
 ...
 * @since 0.24.0
 */
export const SemigroupMin = /*#__PURE__*/semigroup.min(Number.Order);
/**
 ...
 * @since 0.24.0
 */
export const SemigroupMax = /*#__PURE__*/semigroup.max(Number.Order);
/**
 ...
 * @since 0.24.0
 */
export const MonoidSum = /*#__PURE__*/monoid.fromSemigroup(SemigroupSum, 0);
/**
 ...
 * @since 0.24.0
 */
export const MonoidMultiply = /*#__PURE__*/monoid.fromSemigroup(SemigroupMultiply, 1);
/**
