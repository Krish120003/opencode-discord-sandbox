 ...
 * @since 0.24.0
 */
export const SemigroupEvery = /*#__PURE__*/semigroup.make((self, that) => self && that, (self, collection) => {
  if (self === false) {
    return false;
  }
 ...
 * @since 0.24.0
 */
export const SemigroupSome = /*#__PURE__*/semigroup.make((self, that) => self || that, (self, collection) => {
  if (self === true) {
    return true;
  }
  for (const b of collection) {
 ...
 * @since 0.24.0
 */
export const SemigroupXor = /*#__PURE__*/semigroup.make((self, that) => self !== that);
/**
 ...
 * @since 0.24.0
 */
export const SemigroupEqv = /*#__PURE__*/semigroup.make((self, that) => self === that);
/**
 ...
 * @since 0.24.0
 */
export const MonoidEvery = /*#__PURE__*/monoid.fromSemigroup(SemigroupEvery, true);
/**
 ...
 * @since 0.24.0
 */
export const MonoidSome = /*#__PURE__*/monoid.fromSemigroup(SemigroupSome, false);
/**
 ...
 * @since 0.24.0
 */
export const MonoidXor = /*#__PURE__*/monoid.fromSemigroup(SemigroupXor, false);
/**
 ...
 * @since 0.24.0
 */
export const MonoidEqv = /*#__PURE__*/monoid.fromSemigroup(SemigroupEqv, true);
