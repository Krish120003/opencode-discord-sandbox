 ...
 * @since 0.24.0
 */
export const Semigroup = /*#__PURE__*/semigroup.make((self, that) => self !== 0 ? self : that, (self, collection) => {
  let ordering = self;
  if (ordering !== 0) {
    return ordering;
  }
 ...
 * @since 0.24.0
 */
export const Monoid = /*#__PURE__*/monoid.fromSemigroup(Semigroup, 0);
