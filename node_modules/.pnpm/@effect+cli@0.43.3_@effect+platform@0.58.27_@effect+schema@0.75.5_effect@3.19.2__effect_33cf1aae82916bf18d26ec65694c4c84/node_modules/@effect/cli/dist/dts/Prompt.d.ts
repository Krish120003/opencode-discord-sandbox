...
export declare namespace Prompt {
     ...
     * @category models
     */
    interface VarianceStruct<Output> {
     ...
     * @category models
     */
    interface ActionDefinition extends TaggedEnum.WithGenerics<2> {
...
export declare namespace All {
     ...
     * @since 1.0.0
     */
    type ReturnIterable<T extends Iterable<PromptAny>> = [T] extends [Iterable<Prompt.Variance<infer A>>] ? Prompt<Array<A>> : never;
    /**
     * @since 1.0.0
     */
     ...
     * @since 1.0.0
     */
    type Return<Arg extends Iterable<PromptAny> | Record<string, PromptAny>> = [Arg] extends [ReadonlyArray<PromptAny>] ? ReturnTuple<Arg> : [Arg] extends [Iterable<PromptAny>] ? ReturnIterable<Arg> : [Arg] extends [Record<string, PromptAny>] ? ReturnObject<Arg> : never;
}
/**
