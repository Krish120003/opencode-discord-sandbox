...
const withSchema = exports.withSchema = /*#__PURE__*/(0, _Function.dual)(2, (self, schema) => {
  ...
  return mapEffect(self, _ => Effect.mapError(decode(_), error => InternalValidationError.invalidValue(InternalHelpDoc.p(TreeFormatter.formatErrorSync(error)))));
});
/** @internal */
...
const parseInternal = (self, args, config) => {
  switch (self._tag) {
    ...
    case "WithFallback":
      {
        return parseInternal(self.options, args, config).pipe(Effect.catchTag("MissingValue", e => self.effect.pipe(Effect.catchAll(e2 => Predicate.isTagged(e2, "QuitException") ? Effect.die(e2) : Effect.fail(e)))));
      }
  }
};
