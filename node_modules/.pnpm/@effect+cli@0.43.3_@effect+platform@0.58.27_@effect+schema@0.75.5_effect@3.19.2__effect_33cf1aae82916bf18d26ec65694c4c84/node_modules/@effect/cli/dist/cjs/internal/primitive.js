...
exports.wizard = exports.validate = exports.trueValues = exports.text = exports.secret = exports.redacted = exports.path = exports.isTrueValue = exports.isTextType = exports.isSecretType = exports.isPrimitive = exports.isPathType = exports.isIntegerType = exports.isFloatType = exports.isFalseValue = exports.isDateTimeType = exports.isChoiceType = exports.isBoolType = exports.isBool = exports.integer = exports.getZshCompletions = exports.getTypeName = exports.getHelp = exports.getFishCompletions = exports.getChoices = exports.getBashCompletions = exports.float = exports.falseValues = exports.date = exports.choice = exports.boolean = exports.PrimitiveTypeId = void 0;
...
var EffectRedacted = _interopRequireWildcard(require("effect/Redacted"));
var EffectSecret = _interopRequireWildcard(require("effect/Secret"));
...
var InternalDatePrompt = _interopRequireWildcard(require("./prompt/date.js"));
var InternalFilePrompt = _interopRequireWildcard(require("./prompt/file.js"));
...
var InternalTextPrompt = _interopRequireWildcard(require("./prompt/text.js"));
var InternalTogglePrompt = _interopRequireWildcard(require("./prompt/toggle.js"));
...
/** @internal */
const PrimitiveTypeId = exports.PrimitiveTypeId = /*#__PURE__*/Symbol.for(PrimitiveSymbolKey);
const proto = {
  [PrimitiveTypeId]: {
    _A: _ => _
  },
...
const isChoiceType = self => self._tag === "Choice";
/** @internal */
exports.isChoiceType = isChoiceType;
const isDateTimeType = self => self._tag === "DateTime";
/** @internal */
exports.isDateTimeType = isDateTimeType;
const isFloatType = self => self._tag === "Float";
/** @internal */
exports.isFloatType = isFloatType;
const isIntegerType = self => self._tag === "Integer";
/** @internal */
exports.isIntegerType = isIntegerType;
const isPathType = self => self._tag === "Path";
/** @internal */
exports.isPathType = isPathType;
const isSecretType = self => self._tag === "Path";
/** @internal */
exports.isSecretType = isSecretType;
const isTextType = self => self._tag === "Text";
// =============================================================================
// Constructors
// =============================================================================
/** @internal */
exports.isTextType = isTextType;
const trueValues = exports.trueValues = /*#__PURE__*/Schema.Literal("true", "1", "y", "yes", "on");
/** @internal */
const isTrueValue = exports.isTrueValue = /*#__PURE__*/Schema.is(trueValues);
/** @internal */
const falseValues = exports.falseValues = /*#__PURE__*/Schema.Literal("false", "0", "n", "no", "off");
/** @internal */
const isFalseValue = exports.isFalseValue = /*#__PURE__*/Schema.is(falseValues);
/** @internal */
...
const date = exports.date = /*#__PURE__*/(() => {
  const op = /*#__PURE__*/Object.create(proto);
  op._tag = "DateTime";
  return op;
})();
/** @internal */
const float = exports.float = /*#__PURE__*/(() => {
  const op = /*#__PURE__*/Object.create(proto);
  op._tag = "Float";
  return op;
})();
/** @internal */
const integer = exports.integer = /*#__PURE__*/(() => {
  const op = /*#__PURE__*/Object.create(proto);
  op._tag = "Integer";
  return op;
})();
/** @internal */
const path = (pathType, pathExists) => {
  const op = Object.create(proto);
  op._tag = "Path";
...
/** @internal */
exports.path = path;
const redacted = exports.redacted = /*#__PURE__*/(() => {
  const op = /*#__PURE__*/Object.create(proto);
  op._tag = "Redacted";
  return op;
})();
/** @internal */
const secret = exports.secret = /*#__PURE__*/(() => {
  const op = /*#__PURE__*/Object.create(proto);
  op._tag = "Secret";
  return op;
})();
/** @internal */
const text = exports.text = /*#__PURE__*/(() => {
  const op = /*#__PURE__*/Object.create(proto);
  op._tag = "Text";
  return op;
})();
...
const validate = exports.validate = /*#__PURE__*/(0, _Function.dual)(3, (self, value, config) => validateInternal(self, value, config));
/** @internal */
const wizard = exports.wizard = /*#__PURE__*/(0, _Function.dual)(2, (self, help) => wizardInternal(self, help));
// =============================================================================
// Internals
// =============================================================================
const getChoicesInternal = self => {
  switch (self._tag) {
    ...
    case "Choice":
      {
        const choices = (0, _Function.pipe)(Arr.map(self.alternatives, ([choice]) => choice), Arr.join(" | "));
...
const getZshCompletions = self => {
  switch (self._tag) {
    ...
    case "Choice":
      {
        const choices = (0, _Function.pipe)(Arr.map(self.alternatives, ([name]) => name), Arr.join(" "));
