...
/** @internal */
export const options = pageWidth => ({
  pageWidth
});
/** @internal */
export const defaultOptions = /*#__PURE__*/options(InternalPageWidth.defaultPageWidth);
// -----------------------------------------------------------------------------
// wadlerLeijen
// -----------------------------------------------------------------------------
/** @internal */
export const wadlerLeijen = /*#__PURE__*/dual(3, (self, fits, options) => Effect.runSync(wadlerLeijenSafe(InternalPipeline.cons(0, self, InternalPipeline.nil), 0, 0, fits, options)));
const wadlerLeijenSafe = (self, nestingLevel, currentColumn, fits, options) => {
  const best = (self, nl, cc) => Effect.gen(function* (_) {
    switch (self._tag) {
      case "Nil":
        {
...
// -----------------------------------------------------------------------------
/** @internal */
export const compact = self => Effect.runSync(compactSafe(List.of(self), 0));
const compactSafe = (docs, i) => Effect.gen(function* (_) {
  if (List.isNil(docs)) {
    return InternalDocStream.empty;
  }
...
// -----------------------------------------------------------------------------
/** @internal */
export const pretty = /*#__PURE__*/dual(2, (self, options) => {
...
// -----------------------------------------------------------------------------
/** @internal */
export const smart = /*#__PURE__*/dual(2, (self, options) => {
  const width = options.pageWidth;
  if (width._tag === "AvailablePerLine") {
...
// -----------------------------------------------------------------------------
/** @internal */
export const unbounded = self => wadlerLeijen(self, stream => !failsOnFirstLine(stream), {
