...
export type SandboxExecutionRequestCreate = Schema.Schema.Encoded<
  typeof SandboxExecutionRequestSchema
>;
export type SandboxExecutionResultCreate = Schema.Schema.Encoded<
  typeof SandboxExecutionResultSchema
>;
export type SandboxMessageCreate = Schema.Schema.Encoded<
  typeof SandboxMessageSchema
>;
